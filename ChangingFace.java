...
public class ChangingFace extends Application {
    ...
    public void start(Stage stage) {
        ...
        Text caption = new Text(68, 240, "Smiling Face");
        ...
        // create a button that will have no mouth
        Button nomouthButton = new Button("No Mouth");
        ...
        buttonBox.getChildren().addAll(smileButton, frownButton, nomouthButton);
        ...
        smileButton.setOnAction(e -> {mouth.setLength(0); caption.setText("Smile");});
        
        // supply the code that is executed when the frown button is pressed
        frownButton.setOnAction(e -> {mouth.setLength(0); caption.setText("Frown");});

        // supply the code that is executed when the no mouth button is pressed
        nomouthButton.setOnAction(e -> {mouth.setLength(0); caption.setText("No Mouth");});

        // add the scene to the stage, then set the title
        stage.setScene(scene);
        stage.setTitle("Changing Face by Princess Nicole T. Bolo");
